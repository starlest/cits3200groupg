...
public class SearchStaffActivity extends ListActivity {
    ...
    private DBHelper populate(DBHelper d){
    	...
    	d.addStaff("David Raithel", 116, "Postgraduate StudentÕs Association Office", "64883194", "psa@guild.uwa.edu.au", "1500,1300",  "1300,1400",  "0900,1300",  "1200,1400",  "0900,1100");
