...
public class SearchStaffActivity extends ListActivity {
    ...
    private DBHelper populate(DBHelper d){
    	...
    	d.addStaff("Elizabeth OÕShea", 116, "Student Representative Office", 0, "64883773", "ed@guild.uwa.edu.au");
    	...
    	d.addStaff("David Raithel", 116, "Postgraduate StudentÕs Association Office", 0, "64883194", "psa@guild.uwa.edu.au");
