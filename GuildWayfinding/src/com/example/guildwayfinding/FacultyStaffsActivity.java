...
public class FacultyStaffsActivity extends ListActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
		...
		String faculty_name = intent.getStringExtra(SearchFacultyActivity.FACULTY_MESSAGE);
    ...
    protected void onListItemClick (ListView l, View v, int position, long id) {
    	...
    	if (staffId != -1) {
    		Intent intent = new Intent(FacultyStaffsActivity.this, StaffActivity.class);
